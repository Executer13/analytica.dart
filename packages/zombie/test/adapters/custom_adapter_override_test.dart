...
'''),
      ...
      check(zombieNames).contains('pureZombie');

      // Verify tested zombie classified via customTestRunner
      final tested = report.zombies.firstWhere(
        (z) => z.name == 'deadOnlyTested',
      );
      check(tested.classification).equals(ZombieClassification.testedZombie);
      ...
      final hazard = report.zombies.firstWhere(
        (z) => z.name == 'deadCoInvoked',
      );
      check(hazard.classification).equals(ZombieClassification.coInvokedHazard);
...
'''),
        ...
        final testedFinding = report.zombies.firstWhere(
          (z) => z.name == 'deadTested',
        );
        check(
...
'''),
        ...
        final internalMainFinding = report.zombies.firstWhere(
